...
**后续操作提示**（仅在阶段 4 使用了抽样分析时触发）：
报告全部生成完毕后，在报告末尾附上一段文字提醒用户还可以做什么，不要弹选择框，直接文字告知即可：

> 💡 **还可以做：**
> - 如需对全量 N 条文本进行分析，请告诉我「对全量文本进行分析」
> - 如需转换报告格式，请告诉我「转成 Word / Excel / TXT」
> - 如需补充其他维度的交叉分析，请告诉我分组变量即可
